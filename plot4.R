...
plot(pcDataSub$Time, pcDataSub$Voltage, type="l", xlab="datetime", ylab="Voltage")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty=c(1,1,1), lwd=c(1, 1, 1), col=c("black", "red", "blue"), cex=.75, bty="n")
plot(pcDataSub$Time, pcDataSub$Global_reactive_power, type="l", xlab="datetime", ylab="Voltage")
dev.off()